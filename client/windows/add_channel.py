...
class CentralFrame(ctk.CTkFrame):
    def __init__(self, master: AddChannelWindow, controller: Controller):
        ...
        #self.join_channel_frame.pack(expand = True, fill = 'x', side = 'top', anchor = 'center', pady = (20,20), padx = 50)
        ...
        #self.create_channel_frame.pack(expand = True, fill = 'x', side = 'top', anchor = 'center', pady = (20,400), padx = 50)
        ...
        #self.back_button.pack(expand= True, side= 'right', anchor = 'e', padx = 15, pady = 15)
...
class CreateChannelFrame(ctk.CTkFrame): 
    def __init__(self, master, controller: Controller):
        ...
        self.channel_id_entry_box = PlaceHolderEntry(self, "Channel Name", width = 450, height = 50, font=('TkDefaultFont', 16))
        self.channel_id_entry_box.grid(row = 1, column = 0)

        self.channel_create_button = ctk.CTkButton(self, text='Create',  command = self.channel_id_submit_button_clicked, width = 120, height = 50, font=('TkDefaultFont', 16))
